...
const GroupViewAll = () => {
    ...
    const [state, setState] = React.useState({
        groups: [{id: "123",name: "Priciples of ecnomics",title: "principles of economics",
        }],
        logintoken: '',
        allGroups: true
    });
        ...
        <div id="scrollableDiv" className={classes.profilecontainer}>
            ...
            <div className={classes.centergroupcontainer}>
                ...
                {state.groups.map(function(group){
                    return <DisplayGroup key={group.id} id={group.id} userId={user} name={group.title} memberscount={state.groups.length} description={group.about}/>
                })
                }
                </div>
            </div>
